...
func TestLoadFPVVideoConfig(t *testing.T) {
	...
	t.Setenv("API_FPV_VIDEO_MEDIAMTX_WORK_DIR", "/tmp/dr600ab-fpv-video")
	...
	t.Setenv("API_FPV_VIDEO_RECORD_DIR", "/var/lib/dr600ab/fpv-videos")
	t.Setenv("API_FPV_VIDEO_RECORD_DB_PATH", "/var/lib/dr600ab/fpv-videos.db")
	t.Setenv("API_FPV_COMMAND_TIMEOUT_MS", "4500")
	t.Setenv("API_POSITION_TARGET_TTL_SECONDS", "12")
	t.Setenv("API_INTRUSION_DB_PATH", "/var/lib/dr600ab/intrusions.db")
	t.Setenv("API_USER_SETTINGS_PATH", "/var/lib/dr600ab/user-settings.json")
	...
	if cfg.FPVVideo.MediaMTXWorkDir != "/tmp/dr600ab-fpv-video" {
	...
	if cfg.FPVVideo.RecordDir != "/var/lib/dr600ab/fpv-videos" {
		t.Fatalf("record dir = %q", cfg.FPVVideo.RecordDir)
	}
	if cfg.FPVVideoRecordDBPath != "/var/lib/dr600ab/fpv-videos.db" {
	...
	if cfg.IntrusionDBPath != "/var/lib/dr600ab/intrusions.db" {
		t.Fatalf("intrusion db path = %q", cfg.IntrusionDBPath)
	}
	if cfg.UserSettingsPath != "/var/lib/dr600ab/user-settings.json" {
